...
namespace graphic_editor
{
    public partial class MainWindow : Window
    {
        ...
        private void Window_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Enter && _currentTool is PolygonTool polygonTool)
            {
                polygonTool.CompleteWithKey(Cava);
            }
            else if (e.Key == Key.Escape && _currentTool is PolygonTool)
            {
                SetCurrentTool(new SelectTool(_context));
            }
        }
